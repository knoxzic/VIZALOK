...
EIQ.config = {
  ...
  nav: [
    ...
    { id: "capture", label: "Capture", icon: "◎", phase: 2, href: "#/capture", live: true },
    { id: "transactions", label: "Transactions", icon: "☰", phase: 3, href: "#/transactions", live: true },
    { id: "bookings", label: "Bookings & Tasks", icon: "☑", phase: 2, href: "#/bookings", live: true },
